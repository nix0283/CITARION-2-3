...
export type ExchangeConnectionStatus = 'connected' | 'disconnected' | 'no_ws';

export interface DemoExchangeStatusItem {
  name: string;
  id: string;
  status: ExchangeConnectionStatus; // connected = API connected, disconnected = no API but WS available, no_ws = no websocket
  latency: number;
  lastUpdate: Date;
  hasApi: boolean;
...
export const demoExchangeStatus: DemoExchangeStatusItem[] = [
  { 
    name: 'Binance', 
    id: 'binance',
    status: 'connected', 
...
export const demoExchangeBalances: DemoExchangeBalance[] = [
  ...
  {
    exchange: 'Bitget',
    totalBalanceUSDT: 15678.90,
    availableUSDT: 6234.56,
    inOrderUSDT: 3456.78,
    inPositionUSDT: 5987.56,
    unrealizedPnl: 567.89,
    todayPnl: 234.56,
    todayPnlPercent: 1.52,
    weekPnl: 1890.34,
    weekPnlPercent: 13.72,
    monthPnl: 4567.89,
    monthPnlPercent: 41.12,
    assets: [
      {
        symbol: 'BTC',
        name: 'Bitcoin',
    ...
    lastSync: new Date(Date.now() - 4000),
    apiStatus: 'connected',
    permissions: ['read', 'trade'],
  },
  {
    exchange: 'BingX',
    totalBalanceUSDT: 8765.43,
    availableUSDT: 3456.78,
    inOrderUSDT: 2123.45,
    inPositionUSDT: 3185.20,
    unrealizedPnl: 345.67,
    todayPnl: 178.90,
    todayPnlPercent: 2.08,
    weekPnl: 1234.56,
    weekPnlPercent: 16.41,
    monthPnl: 2890.12,
    monthPnlPercent: 49.20,
    assets: [
      {
        symbol: 'BTC',
        name: 'Bitcoin',
...
export const demoFundingRates: DemoFundingRate[] = [
  ...
  },
  {
    ...
    exchange: 'Bybit',
    fundingRate: -0.00042,
    fundingRateAnnualized: -36.79,
    nextFundingTime: new Date(Date.now() + 1000 * 60 * 60 * 4),
    openInterest: 1890000000,
    openInterestChange24h: -4.23,
    longShortRatio: 0.91,
    liquidationHeat: 'medium',
  },
  // OKX Funding Rates
  {
    ...
    exchange: 'OKX',
    fundingRate: 0.00013,
    fundingRateAnnualized: 11.39,
    nextFundingTime: new Date(Date.now() + 1000 * 60 * 60 * 2),
    predictedRate: 0.00014,
    openInterest: 7200000000,
    openInterestChange24h: 2.89,
    longShortRatio: 1.10,
    liquidationHeat: 'low',
  },
  {
    ...
    exchange: 'OKX',
    fundingRate: 0.00010,
    fundingRateAnnualized: 8.76,
    nextFundingTime: new Date(Date.now() + 1000 * 60 * 60 * 2),
    openInterest: 4500000000,
    openInterestChange24h: 1.98,
    longShortRatio: 1.07,
    liquidationHeat: 'low',
  },
  {
  ...
  // Bitget Funding Rates
  {
    symbol: 'BTCUSDT',
    exchange: 'Bitget',
    fundingRate: 0.00011,
    fundingRateAnnualized: 9.63,
    nextFundingTime: new Date(Date.now() + 1000 * 60 * 60 * 8),
    openInterest: 4500000000,
    openInterestChange24h: 3.12,
    longShortRatio: 1.08,
    liquidationHeat: 'low',
  },
  {
    ...
    exchange: 'Bitget',
    fundingRate: 0.00007,
    fundingRateAnnualized: 6.13,
    nextFundingTime: new Date(Date.now() + 1000 * 60 * 60 * 8),
    openInterest: 3450000000,
    openInterestChange24h: 4.23,
    longShortRatio: 1.09,
    liquidationHeat: 'low',
  },
  {
    ...
    exchange: 'Bitget',
    fundingRate: -0.00040,
    fundingRateAnnualized: -35.04,
    nextFundingTime: new Date(Date.now() + 1000 * 60 * 60 * 8),
    openInterest: 980000000,
    openInterestChange24h: -2.67,
    longShortRatio: 0.88,
    liquidationHeat: 'medium',
  },
  // BingX Funding Rates
