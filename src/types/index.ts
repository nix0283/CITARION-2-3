...
/**
 * Input type for bot configuration forms and API requests.
 * NOTE: This is different from the Prisma BotConfig model which is used for database storage.
 * For Prisma model, import from '@prisma/client' as needed.
 */
...
/**
 * @deprecated Use BotConfigInput instead. This alias will be removed in a future version.
 * Import BotConfig from '@prisma/client' for database model.
 */
